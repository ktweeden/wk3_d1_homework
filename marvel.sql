...
-- Oops! Someone at CodeClan spelled Kate's name wrong! Change it to reflect
-- the proper spelling (change 'Kte Preston' to 'Kate Preston').
UPDATE people
SET name = 'Kate Preston'
WHERE name = 'Kte Preston';

-- Return ONLY your name from the 'people' table.
SELECT name FROM people WHERE name = 'Kate Preston';
...
DELETE FROM people WHERE name IN ('Kate Preston', 'Amy Robertson');
